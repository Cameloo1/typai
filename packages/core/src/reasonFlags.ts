export const TypaiReasonFlag = {
  ...
  COMMON_TYPO_TABLE_EXPANDED: 1 << 16,
  CASE_PRESERVED: 1 << 17,
  PUNCTUATION_PRESERVED: 1 << 18,
  DELETE_INDEX_CANDIDATE: 1 << 19,
  FREQUENCY_RANKED: 1 << 20,
  AUTOCORRECT_GATE_PASSED: 1 << 21,
  AUTOCORRECT_GATE_BLOCKED: 1 << 22,
  VALID_WORD_BLOCK: 1 << 23,
  PROTECTED_TOKEN_BLOCK: 1 << 24,
} as const;
...
const reasonFlagEntries = [
  ...
  ["COMMON_TYPO_TABLE_EXPANDED", TypaiReasonFlag.COMMON_TYPO_TABLE_EXPANDED],
  ["CASE_PRESERVED", TypaiReasonFlag.CASE_PRESERVED],
  ["PUNCTUATION_PRESERVED", TypaiReasonFlag.PUNCTUATION_PRESERVED],
  ["DELETE_INDEX_CANDIDATE", TypaiReasonFlag.DELETE_INDEX_CANDIDATE],
  ["FREQUENCY_RANKED", TypaiReasonFlag.FREQUENCY_RANKED],
  ["AUTOCORRECT_GATE_PASSED", TypaiReasonFlag.AUTOCORRECT_GATE_PASSED],
  ["AUTOCORRECT_GATE_BLOCKED", TypaiReasonFlag.AUTOCORRECT_GATE_BLOCKED],
  ["VALID_WORD_BLOCK", TypaiReasonFlag.VALID_WORD_BLOCK],
  ["PROTECTED_TOKEN_BLOCK", TypaiReasonFlag.PROTECTED_TOKEN_BLOCK],
] as const;
